...
class PendingActivityJobTest {
    ...
    void init() {
        ...
        when(file.getHashPath()).thenReturn(assetHashPath);
        ...
        when(file.getName()).thenReturn(assetName);
    ...
    void testEvolve() {
        ...
        assertEquals(file, evolved.file());
    ...
    void testRun() throws Exception {
        ...
        verify(activityHandler, times(1)).handle(file, eventType, configuredEnv);
