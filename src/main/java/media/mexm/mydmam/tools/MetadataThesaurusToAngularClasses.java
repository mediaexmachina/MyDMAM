...
public class MetadataThesaurusToAngularClasses {
    ...
    public void make(final File angularProjectDestination) throws IOException {
        ...
        createDtoMetadataThesaurusEntry(angularDtoDirectory, dtoClassName);
    ...
    private void createDtoMetadataThesaurusEntry(final File angularDtoDirectory,
                                                 final String dtoClassName) throws IOException {
